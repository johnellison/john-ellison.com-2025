          ...
          <div className="space-y-8">
            ...
            <div className="journey-section about-bio-item">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="journey-tag group p-4 rounded-xl bg-gradient-to-br from-violet-500/10 to-blue-500/10 border border-violet-500/20 hover:border-violet-400/40 transition-all duration-300">
                  ...
                  <p className="type-xs text-white/60">16+ years building startups</p>
                </div>
                ...
                <div className="journey-tag group p-4 rounded-xl bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 hover:border-emerald-400/40 transition-all duration-300">
                  ...
                  <p className="type-xs text-white/60">ReFi movement builder</p>
                </div>

                <div className="journey-tag group p-4 rounded-xl bg-gradient-to-br from-amber-500/20 to-orange-500/20 border border-amber-500/40 hover:border-amber-400/60 transition-all duration-300">
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="type-xs text-white/60">Pilgrimage documentary</p>
                </div>
            ...
            <div className="about-links about-bio-item flex flex-wrap gap-4 pt-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="about-link inline-flex items-center gap-2 px-6 py-3 bg-red-600/20 border border-red-500/50 rounded-xl text-red-200 hover:bg-red-600/30 hover:border-red-400/70 transition-all duration-300 type-base font-medium"
              >
                Watch on YouTube
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
